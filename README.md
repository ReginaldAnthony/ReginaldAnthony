...
As a certified Google Data analyst, I have an excellent understanding and proficiency in data collection, data cleaning, relational databases, SQL, BigQuery, and R programming. Additionally, I possess strong data analytics and data visualization skills, utilizing tools such as spreadsheets (Sheets, Excel), RStudio, and Tableau.
